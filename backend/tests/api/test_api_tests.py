...
def test_get_tests_from_test_run(mocker: MockerFixture):
    mocker.patch('services.tests.TestsService.get_tests_from_test_run', return_value=test_data2)
...
def test_get_history_by_test_id(mocker: MockerFixture):
    mocker.patch('services.tests.TestsService.get_history_by_test_id', return_value=test_data3)
...
test_data = {"uuid": "b63dde90-2df6-4ae6-8ac3-8c8d396d3969",
             "location": "test_0",
